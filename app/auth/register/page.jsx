...
import { Eye, EyeOff, Mail, Lock, User, Phone, MapPin, Store, ShoppingBag } from 'lucide-react';
              ...
              <FormProvider {...methods}>
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <FormInput name="firstName" label="First Name *" placeholder="First name" icon={User} />
                    <FormInput name="lastName" label="Last Name *" placeholder="Last name" />
                  </div>

                  <FormInput name="email" label="Email Address *" placeholder="Enter your email" icon={Mail} />
                  <FormInput name="phone" label="Phone Number *" placeholder="+254 700 000 000" icon={Phone} />

                  <FormSelect name="country" label="Country *" icon={MapPin}>
                  ...
                  <FormButton isLoading={isSubmitting}>Create Account</FormButton>
                </form>
              </FormProvider>
