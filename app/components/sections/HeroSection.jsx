...
//           <button className="bg-yellow-500 hover:bg-yellow-600 text-black font-semibold px-6 lg:px-8 py-3 lg:py-4 rounded-lg text-base lg:text-lg transition-all duration-300 transform hover:scale-105 shadow-lg w-full">
//             Shop Now
//           </button>
//         </a>
...
//   return (
//     <section className="min-h-screen bg-gradient-to-br from-orange-500 via-orange-600 to-green-600 overflow-hidden">
